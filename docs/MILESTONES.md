...
| M4 Landing economy | **Playable; the opening debt is not built** | Commodity/TradeData/CargoHold/Outfitting, local commodity transactions with saved average purchase costs and profit reporting, separate hull/outfit depreciation, signed shop stock, daily sales, normal production shocks, linked-system exchanges and saved market state. Cargo pools ashore and survives ship sales and reloads; departure loads freight first and asks before selling excess goods or abandoning uncarryable jobs. The shipyard selects local hulls, confirms sales and refreshes equipped prices as used stock changes. Selling the last ship, saving at port, buying a replacement and departing are playable. The outfitter selects local ships, sells unlisted installed equipment, services modified hulls and preserves buyback stock through reload until departure. Individual port services, per-ship landing clearance, outfit storage/licences, chassis-only sales, trade-in and jettison/plunder cost accounting remain incomplete. |
