...
<#
.SYNOPSIS
  Runs save/load, paid-bounty, owned-escort and port-shop scenarios from a relocated release package.
.DESCRIPTION
...
try {
    ...
    foreach ($scenario in 'save', 'mission', 'fleet', 'shipyard', 'outfitter') {
